                ...
                <div class="card-body">
                    <form action="{{ route('pengguna.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control py-4" value="{{ old('name') }}" name="name" placeholder="Masukkan Nama" required autofocus>
                        </div>

                        <div class="form-group">
                            <label for="" class="mb1">Nama Belakang</label>
                            <input type="name" class="form-control py-4" value="{{ old('last_name') }}" name="last_name" placeholder="Masukkan Nama Belakang" required>
                        </div>
